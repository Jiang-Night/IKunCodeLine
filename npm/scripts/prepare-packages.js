...
platforms.forEach(platform => {
  ...
  console.log(`✓ Prepared @ikuncode/ikuncodeline-${platform} v${version}`);
});
...
if (mainPackageJson.optionalDependencies) {
  Object.keys(mainPackageJson.optionalDependencies).forEach(dep => {
    if (dep.startsWith('@ikuncode/ikuncodeline-')) {
...
console.log(`✓ Prepared @ikuncode/ikuncodeline v${version}`);
